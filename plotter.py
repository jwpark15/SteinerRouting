...
def generate_plots(file_pts, file_mst, file_lrst, file_kr, file_kr_lengths, file_kr_steiners):
    # initialize plots
...
if __name__ == "__main__":
    ...
    print(points_file)
    generate_plots(points_file, "primResults.txt", "LRSTResults.txt", "KRResults.txt", "KRWireLengths.txt", "KRSteiners.txt")